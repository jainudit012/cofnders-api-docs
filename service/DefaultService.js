...
exports.fundsPOST = function(authorization,fund) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = "{error=false, msg=Fund has been Added. Under Approval, fund={investorType=ANGEL_NETWORK, preferredStartupStage=MVP, createdBy={_id=5c9efdde0bb9defc9c218c65, firstName=Udit, lastName=Jain, email=jainudit.012@gmail.com, emailVerified=true, profilePicture=https://media.licdn.com/dms/image/C5103AQG_1EUajUCTXg/profile-displayphoto-shrink_100_100/0?e=1559174400&v=beta&t=WQDJMxQCMYLl4rJ2yYszirYi-rVnd2q1xvtD5greIyY, fullName=Udit Jain, sub=linkedin|oP4sPrYxft, purpose=this is the new purpose 2.0, brief=my brief, isAdmin=false, isActive=true, createdAt=2019-03-30T05:25:50.413Z, updatedAt=2019-04-06T09:31:23.942Z}, isApproved=false, linkedInProfile=www.linkedin.com/?profile=2190jkwq, contact=8329829389, createdAt=2019-04-10T12:24:27.931Z, updatedAt=2019-04-10T12:24:27.931Z, _id=5cade07b3b9bf3b6d8270fe7}}";
    if (Object.keys(examples).length > 0) {
      resolve(examples[Object.keys(examples)[0]]);
    } else {
      resolve();
